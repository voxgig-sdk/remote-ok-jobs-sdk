...
describe('GetAllJobDirect', async () => {
  ...
  test('direct-list-get_all_job', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-get_all_job', setup.live)) return
