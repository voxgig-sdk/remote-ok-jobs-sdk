// Command RemoteOkJobs-mcp is an MCP server exposing the RemoteOkJobs
// SDK as MCP tools.
//
// Two tools are registered:
//
//	RemoteOkJobs_list  — list records of an entity
//	RemoteOkJobs_load  — load a single record of an entity
//
