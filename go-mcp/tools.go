...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_all_job"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.RemoteOkJobsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "remote-ok-jobs_list",
		Description: "List records from RemoteOkJobs. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "remote-ok-jobs_load",
		Description: "Load a single record from RemoteOkJobs. " +
...
func runOp(client *sdk.RemoteOkJobsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.RemoteOkJobsSDK, name string) (sdk.RemoteOkJobsEntity, error) {
	switch strings.ToLower(name) {
	case "get_all_job":
		return client.GetAllJob(nil), nil
