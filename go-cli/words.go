...
func registerSDKWords(r *eng.Registry, client *sdk.RemoteOkJobsSDK) {
...
func runOp(client *sdk.RemoteOkJobsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
