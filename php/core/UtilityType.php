...
// RemoteOkJobs SDK utility type

class RemoteOkJobsUtility
{
    ...
    public static function copy(RemoteOkJobsUtility $src): RemoteOkJobsUtility
    {
        $u = new RemoteOkJobsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
