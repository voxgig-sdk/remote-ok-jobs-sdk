...
// RemoteOkJobs SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class RemoteOkJobsTransformResponse
{
    public static function call(RemoteOkJobsContext $ctx): mixed
    {
        ...
        $transform = RemoteOkJobsHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
