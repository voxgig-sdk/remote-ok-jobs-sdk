...
class RemoteOkJobsTestRunner
{
    ...
    {
        $live = self::getenv('REMOTEOKJOBS_TEST_LIVE');
        $override = self::getenv('REMOTEOKJOBS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('REMOTEOKJOBS_TEST_EXPLAIN');
...
class_alias('RemoteOkJobsTestRunner', 'Runner');
class_alias('RemoteOkJobsHelpers', 'Helpers');
