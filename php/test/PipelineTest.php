...
// RemoteOkJobs SDK pipeline test
//
...
require_once __DIR__ . '/../remoteokjobs_sdk.php';
...
{
    private static function utility(): RemoteOkJobsUtility
    {
        return new RemoteOkJobsUtility();
    }
    ...
    private static function ctx(array $over = []): RemoteOkJobsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new RemoteOkJobsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new RemoteOkJobsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof RemoteOkJobsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new RemoteOkJobsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = RemoteOkJobsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new RemoteOkJobsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = RemoteOkJobsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new RemoteOkJobsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = RemoteOkJobsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RemoteOkJobsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = RemoteOkJobsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new RemoteOkJobsResponse([]),
            'result' => new RemoteOkJobsResult([]),
        ]);
        [, $err] = RemoteOkJobsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new RemoteOkJobsSpec([]),
            'response' => null,
            'result' => new RemoteOkJobsResult([]),
        ]);
        [, $err] = RemoteOkJobsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new RemoteOkJobsSpec(['step' => 's']),
            'response' => new RemoteOkJobsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new RemoteOkJobsResult([]),
        ]);
        [, $err] = RemoteOkJobsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new RemoteOkJobsSpec(['step' => 's']),
            'response' => new RemoteOkJobsResponse(self::resp(200, ['v' => 1])),
            'result' => new RemoteOkJobsResult([]),
        ]);
        [, $err] = RemoteOkJobsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new RemoteOkJobsSpec(['step' => 's']),
            'response' => new RemoteOkJobsResponse(self::resp(200, ['v' => 2])),
            'result' => new RemoteOkJobsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        RemoteOkJobsMakeResponse::call($ctx);
    ...
    {
        $preset = new RemoteOkJobsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new RemoteOkJobsSpec([]),
            'response' => new RemoteOkJobsResponse([]),
            'result' => new RemoteOkJobsResult([]),
        ...
        [$got, $err] = RemoteOkJobsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new RemoteOkJobsResult([])]);
        [, $err] = RemoteOkJobsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new RemoteOkJobsSpec([]), 'result' => null]);
        [, $err] = RemoteOkJobsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RemoteOkJobsSpec(['step' => 's']),
            'result' => new RemoteOkJobsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new RemoteOkJobsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RemoteOkJobsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RemoteOkJobsSpec(['step' => 's']),
            'result' => new RemoteOkJobsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new RemoteOkJobsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RemoteOkJobsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RemoteOkJobsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new RemoteOkJobsSpec([]),
            'result' => new RemoteOkJobsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = RemoteOkJobsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RemoteOkJobsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new RemoteOkJobsError('boom', 'boom');
        $utility->fetcher = function (RemoteOkJobsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RemoteOkJobsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = RemoteOkJobsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (RemoteOkJobsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = RemoteOkJobsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(RemoteOkJobsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        RemoteOkJobsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (RemoteOkJobsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RemoteOkJobsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = RemoteOkJobsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new RemoteOkJobsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new RemoteOkJobsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = RemoteOkJobsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = RemoteOkJobsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = RemoteOkJobsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new RemoteOkJobsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, RemoteOkJobsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new RemoteOkJobsResult(['ok' => false])]);
        $this->expectException(RemoteOkJobsError::class);
        RemoteOkJobsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new RemoteOkJobsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', RemoteOkJobsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        RemoteOkJobsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new RemoteOkJobsBaseFeature();
        $b = new RemoteOkJobsBaseFeature();
        RemoteOkJobsFeatureAdd::call($ctx, $a);
        RemoteOkJobsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): RemoteOkJobsBaseFeature
    {
        $f = new RemoteOkJobsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        RemoteOkJobsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): RemoteOkJobsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new RemoteOkJobsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RemoteOkJobsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        RemoteOkJobsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new RemoteOkJobsResponse(['headers' => null]),
            'result' => new RemoteOkJobsResult([]),
        ]);
        RemoteOkJobsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        RemoteOkJobsResultBody::call($ctx);
