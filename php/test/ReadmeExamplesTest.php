...
// RemoteOkJobs SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RemoteOkJobsSDK::test)
...
{
    private const SDK_CLASS = 'RemoteOkJobsSDK';
    ...
    private const SDK_BASE = 'remoteokjobs_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../remoteokjobs_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
