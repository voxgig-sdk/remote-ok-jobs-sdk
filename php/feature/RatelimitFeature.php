...
// RemoteOkJobs SDK ratelimit feature
...
class RemoteOkJobsRatelimitFeature extends RemoteOkJobsBaseFeature
{
    ...
    private function _acquire(RemoteOkJobsContext $ctx): void
    {
    ...
    private function _track(RemoteOkJobsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
