...
// RemoteOkJobs SDK audit feature
...
class RemoteOkJobsAuditFeature extends RemoteOkJobsBaseFeature
{
    ...
    private function _emit(RemoteOkJobsContext $ctx, string $outcome): void
    {
