...
class RemoteOkJobsRbacFeature extends RemoteOkJobsBaseFeature
{
    ...
    private function _required(RemoteOkJobsContext $ctx): ?string
    {
    ...
    private function _reject(RemoteOkJobsContext $ctx, string $required): void
    {
    ...
    private function _track(RemoteOkJobsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
