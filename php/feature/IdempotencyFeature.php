...
// RemoteOkJobs SDK idempotency feature
...
class RemoteOkJobsIdempotencyFeature extends RemoteOkJobsBaseFeature
{
    ...
    private function _mutating(RemoteOkJobsContext $ctx): bool
    {
