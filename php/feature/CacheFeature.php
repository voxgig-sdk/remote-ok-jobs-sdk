...
// RemoteOkJobs SDK cache feature
...
class RemoteOkJobsCacheFeature extends RemoteOkJobsBaseFeature
{
    ...
    private function _through(RemoteOkJobsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
