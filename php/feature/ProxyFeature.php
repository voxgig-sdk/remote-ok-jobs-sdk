...
// RemoteOkJobs SDK proxy feature
...
class RemoteOkJobsProxyFeature extends RemoteOkJobsBaseFeature
{
    ...
    public function init(RemoteOkJobsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RemoteOkJobsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
