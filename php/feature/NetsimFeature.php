...
// RemoteOkJobs SDK netsim feature
...
class RemoteOkJobsNetsimFeature extends RemoteOkJobsBaseFeature
{
    ...
    private function _simulate(RemoteOkJobsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RemoteOkJobsContext $ctx, array $applied): void
    {
        $client = $this->client;
