# RemoteOkJobs SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RemoteOkJobsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RemoteOkJobsSDK(...) and RemoteOkJobsSDK.test(...) become
#      RemoteOkJobsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "remoteokjobs_sdk"
_SDK_CLASS = "RemoteOkJobsSDK"
