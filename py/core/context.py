...
from core.control import RemoteOkJobsControl
...
class RemoteOkJobsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, RemoteOkJobsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, RemoteOkJobsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RemoteOkJobsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return RemoteOkJobsError(code, msg, self)
