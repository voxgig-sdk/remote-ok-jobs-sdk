...
// RemoteOkJobs SDK utility: fetcher

class RemoteOkJobsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RemoteOkJobsSDK/1.0)';
    ...
    public static function call(RemoteOkJobsContext $ctx, string $fullurl, array $fetchdef): array
    {
