...
// RemoteOkJobs SDK metrics feature
...
class RemoteOkJobsMetricsFeature extends RemoteOkJobsBaseFeature
{
    ...
    private function _record(RemoteOkJobsContext $ctx, bool $ok): void
    {
