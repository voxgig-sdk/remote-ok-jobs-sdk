...
// RemoteOkJobs SDK timeout feature
...
class RemoteOkJobsTimeoutFeature extends RemoteOkJobsBaseFeature
{
    ...
    private function _with_timeout(RemoteOkJobsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RemoteOkJobsContext $_ctx, float $ms): void
    {
        $client = $this->client;
