...
// RemoteOkJobs SDK telemetry feature
...
class RemoteOkJobsTelemetryFeature extends RemoteOkJobsBaseFeature
{
    ...
    private function _close(RemoteOkJobsContext $ctx, bool $ok): void
    {
