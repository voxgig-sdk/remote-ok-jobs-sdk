...
// RemoteOkJobs SDK streaming feature
...
class RemoteOkJobsStreamingFeature extends RemoteOkJobsBaseFeature
{
    ...
    private function _iterate(RemoteOkJobsResult $result): \Generator
    {
    ...
    private function _streamable(RemoteOkJobsContext $ctx): bool
    {
