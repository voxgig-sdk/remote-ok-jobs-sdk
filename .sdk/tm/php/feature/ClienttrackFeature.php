...
// RemoteOkJobs SDK clienttrack feature
...
class RemoteOkJobsClienttrackFeature extends RemoteOkJobsBaseFeature
{
    ...
    public function PostConstruct(RemoteOkJobsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RemoteOkJobs-SDK';
