...
from projectname_sdk import RemoteOkJobsSDK
from core.spec import RemoteOkJobsSpec
from core.result import RemoteOkJobsResult
from core.response import RemoteOkJobsResponse
from core.operation import RemoteOkJobsOperation
from core.error import RemoteOkJobsError
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return RemoteOkJobsError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = RemoteOkJobsSDK.test(None, None)
        ...
        class TestInitFeature(RemoteOkJobsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(RemoteOkJobsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = RemoteOkJobsSDK({
            "system": {
                "fetch": mock_fetch,
            },
        })
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = RemoteOkJobsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = RemoteOkJobsSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = RemoteOkJobsOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = RemoteOkJobsSDK.test(None, setup_opts)
