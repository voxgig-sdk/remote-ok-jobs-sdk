...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/remote-ok-jobs` | `npm install @voxgig-sdk/remote-ok-jobs` |
| Python | `voxgig-sdk-remote-ok-jobs` | `pip install voxgig-sdk-remote-ok-jobs` |
| PHP | `voxgig-sdk/remote-ok-jobs` | `composer require voxgig-sdk/remote-ok-jobs` |
| Golang | `github.com/voxgig-sdk/remote-ok-jobs-sdk/go` | `go get github.com/voxgig-sdk/remote-ok-jobs-sdk/go` |
| Ruby | `voxgig-sdk-remote-ok-jobs` | `gem install voxgig-sdk-remote-ok-jobs` |
| Lua | `voxgig-sdk-remote-ok-jobs` | `luarocks install voxgig-sdk-remote-ok-jobs` |
