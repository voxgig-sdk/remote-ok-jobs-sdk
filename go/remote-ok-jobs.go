...
// instead of `sdk.NewRemoteOkJobsSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *RemoteOkJobsSDK  { return NewRemoteOkJobsSDK(nil) }
func Test() *RemoteOkJobsSDK { return TestSDK(nil, nil) }
