...
#      offline in seeded test mode (RemoteOkJobsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "RemoteOkJobs_sdk.rb")
  SDK_CLASS = "RemoteOkJobsSDK"
