...
module RemoteOkJobsTestRunner
  ...
  def self.env_override(m)
    live = getenv("REMOTEOKJOBS_TEST_LIVE")
    override = getenv("REMOTEOKJOBS_TEST_OVERRIDE")
    ...
    explain = getenv("REMOTEOKJOBS_TEST_EXPLAIN")
    m["REMOTEOKJOBS_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = RemoteOkJobsTestRunner
Helpers = RemoteOkJobsHelpers
Vs = VoxgigStruct
