...
describe("GetAllJobDirect", function()
  it("should direct-list-get_all_job", function()
    local setup = get_all_job_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-get_all_job", setup.live and "live" or "unit")
